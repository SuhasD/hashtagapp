...
function resultBlock($errors,$successes){
	...
	if(count($errors) > 0)
	{
		...
		<a href='javascript:void(0)' class='close' onclick=\"showHide('error');\"><span aria-hidden='true'>&times;</span><span class='sr-only'>Close</span></a>";
	...
	if(count($successes) > 0)
	{
		...
		<a href='javascript:void(0)' class='close' onclick=\"showHide('success');\"><span aria-hidden='true'>&times;</span><span class='sr-only'>Close</span></a>";
